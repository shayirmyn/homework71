            ...
            </div>
            {
                loading.getLoading ? <Spinner /> :
                    orders.map(order => {
                        ...
                        return (
                            <div key={order.id} className="innerPost mt-2 mb-2 shadow-lg p-2 bg-body-tertiary">
                                {
                                        ...
                                        <div key={dish.id}>
                                            <div className="innerPost mt-2 shadow-lg p-2 mb-2 bg-body-tertiary">
                                                <div className="card-footer text-body-secondary d-flex">
                                                    ...
                                                    <span className="ms-auto">X<strong>{dish.amount}</strong></span>
                                ...
                                <h4><strong>total Price: {totalPrice} KGS</strong></h4>
                                <button className="btn btn-danger ms-auto" onClick={() => onDelete(order.id)}>{
                                    loading.deleteLoading && <BtnSpinner />
                                }
                                    Complete order
                                </button>
                            </div>
