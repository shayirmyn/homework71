...
const UserHome = () => {
    ...
    let checkout: React.ReactNode | null = isCheckout ? <CheckOut onDelete={onDelete} cancel={() => setIsCheckout(false)} basket={basket}/> : null;
    ...
    return (
        <div className="card text-center postCard shadow-lg p-3 mt-5 bg-body-tertiary">
            <div className="dishesHead">
                ...
                <div>
                    <button className="btn btn-success" onClick={() => setIsCheckout(true)}>Checkout</button>
                </div>
            </div>
                    ...
                    <div key={dish.id}>
                        <div className="innerPost mt-2 shadow-lg p-2 mb-2 bg-body-tertiary">
                            ...
                            <div className="card-footer text-body-secondary d-flex justify-content-between">
                                ...
                                <div>
                                    <button className="btn btn-primary" onClick={() => addToBasket(dish)}>Add to order
                                    </button>
                                </div>
                            </div>
                        </div>
